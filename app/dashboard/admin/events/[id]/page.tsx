...
import { Calendar, MapPin, Users, ArrowLeft, Mail, User } from "lucide-react"
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-start justify-between gap-4">
              ...
              <AdminEventActions eventId={typedEvent.id} currentStatus={typedEvent.status} />
            </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {typedEvent.creator?.full_name || typedEvent.creator?.email || "Unknown"}
                    </p>
                  </div>
                </div>
